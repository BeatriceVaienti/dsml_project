...
image_path_left = 'C:\\Users\\berret_c\\Documents\\GitHub\\dsml_project\\streamlit\\Berre.png'
image_path_right = 'C:\\Users\\berret_c\\Documents\\GitHub\\dsml_project\\streamlit\\Vaient.png'
...
# Process user answer and level advancemen
def process_answer():
...
if not st.session_state.test_finished:
    ...
    **This will help you to find your Tandem Match and tailor your learning program based on your conversations.**
    ...
    if st.button('Submit'):
        process_answer()
        st.rerun() # Add this line to rerun the script
